...
import DateTimeforLit from "../../utils/datetimeforlit";
...
const Dashboard = {
  ...
  _templateBodyCard(index, storyRecord) {
    const date = showFormattedDateTime(DateTimeforLit.name, storyRecord.createdAt);
    console.log(DateTimeforLit.name);
    return `
      <listitem-component 
