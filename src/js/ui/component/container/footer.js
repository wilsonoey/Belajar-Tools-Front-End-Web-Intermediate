      ...
      <footer class="home-footer1">
        <div class="home-container2">
          ...
          <nav class="home-nav1">
            ...
            <a href="dashboard.html"> <span class="home-nav22">${msg(`Dashboard`)}</span> </a>
            <a href="addpage.html"> <span class="home-nav22">${msg(`Add Story`)}</span> </a>
            <a href="addpageforguest.html">
              <span class="home-nav22">${msg(`Add Story for Guest`)}</span>
            </a>
          </nav>
        </div>
        <div class="home-separator"></div>
        <div class="home-container3">
          <span class="home-text"> ${msg(`© 2023 myCompany, All Rights Reserved.`)} </span>
